...
import { cartAPI, productAPI } from "./constants"
              ...
              <div className="main-box">
                <div className="product-container">
                  ...
                  <div className="product-details">
                    ...
                    {quantity === 0 ? <button className="out-of-stock" disabled>Out of Stock</button> :
                      <form className="form" onSubmit={formSubmit}>
                        <input type="number" hidden readOnly value={data.id} name="product" />
                        <input type="number" className="number-field" name="quantity" min="1" max={quantity} defaultValue="1" />
